...
// import { auth, loginWithGoogle, logout, db, ADMIN_UID } from "../firebase";
...
//   // Reset semua pesan (khusus admin)
//   const resetChat = async () => {
//     if (!user || user.uid !== ADMIN_UID) {
//       alert("Hanya admin yang bisa reset chat!");
//       return;
//     }
//     const q = await getDocs(collection(db, "messages"));
//     const deletePromises = q.docs.map((msg) =>
//       deleteDoc(doc(db, "messages", msg.id))
//     );
//     await Promise.all(deletePromises);

//     // Kosongkan state agar UI langsung update
//     setMessages([]);
...
//               <button
//                 onClick={resetChat}
//                 className="bg-yellow-600 px-4 py-1 rounded-full text-white hover:bg-yellow-700"
//               >
//                 Reset Chat
//               </button>
//             )}
